...
public class NewGameButton extends MenuButton {
	...
	public NewGameButton(int x, int y, int width, int height, boolean visible, boolean active, MenuItem parent) {
		super(x, y, width, height, visible, active, parent, "neues spiel");
	}
