...
public class World {
	...
	//TODO Listenart ausw�hlen, besser w�re was mit threadsicherheit
	 ...
	 * einer hochzählenden Zahl beginnend bei 1 gehörig dazu das ausgelesene in
	 * ein String[] <a/s> <name>
	 */
	...
	public void loadWorld() throws IOException {
		//Herausfinden wie viele Chunks geladen werden m�ssen
		int amountToLoad = 0;
		...
		for (int y = playerChunkY - LOAD_RANGE; y < playerChunkY + LOAD_RANGE; y++) {
			for (int x = playerChunkX - LOAD_RANGE; x < playerChunkX + LOAD_RANGE; x++) {
				...
				//Prozentzahl berechnen und an World Feedback Receiver zur�ckgeben.
